...
public:
    ...
    void update(float dt); //two cases for this function declared below
...
template <class T>
void ofxAnimatableObject<T>::update(float dt){
    size.update(dt);
    color.update(dt);
    position.update(dt);
    rotation.update(dt);
...
template <>
void ofxAnimatableObject<ofImage>::update(float dt){
    size.update(dt);
    color.update(dt);
    position.update(dt);
    rotation.update(dt);
